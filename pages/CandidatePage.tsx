...
const CandidatePage: React.FC = () => {
  ...
  // Redirect to home if candidate not found
  useEffect(() => {
    if (!candidate) {
      navigate("/");
    }
  ...
  const translatedContent = useMemo(() => {
    ...
    return {
      ...
      location:
        t(`candidates.${candidateKey}.location`) || candidate.location || "",
      keyAchievement:
        t(`candidates.${candidateKey}.keyAchievement`) ||
        candidate.keyAchievement,
      philosophy:
        t(`candidates.${candidateKey}.philosophy`) || candidate.philosophy,
      business: t(`candidates.${candidateKey}.business`) || candidate.business,
      trackRecord:
        t(`candidates.${candidateKey}.trackRecord`) || candidate.trackRecord,
      achievements: (() => {
      ...
      manifesto:
        t(`candidates.${candidateKey}.manifesto`) || candidate.manifesto,
  ...
  const navigateLightbox = useCallback(
    (direction: "prev" | "next") => {
      ...
      if (direction === "next") {
        ...
        newIndex =
          (currentIndex - 1 + ALL_GALLERY_IMAGES.length) %
  ...
  if (!candidate || !translatedContent) {
    return null;
  }
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="flex flex-col md:flex-row">
          ...
          <img
            src={
              candidate.id === "pernilla"
                ? "/Pernilla Headshot.jpg"
                : candidate.id === "lumi"
                  ? "/Lumi/WhatsApp Image 2025-12-09 at 19.07.56.jpeg"
                  : candidate.imageHeadshot
            }
            onError={(e) => {
              (e.target as HTMLImageElement).src =
                `https://picsum.photos/300/300?random=${candidate.id}2`;
            }}
            className="w-32 h-32 rounded-full border-4 border-gold shadow-lg mb-6 mx-auto md:mx-0 object-cover"
            style={{
              objectPosition: candidate.id === "lumi" ? "80% -10%" : "center",
            }}
            alt={translatedContent.name}
          />
          <h3 className="text-2xl font-bold mb-1">{translatedContent.name}</h3>
          <p className="text-gold font-medium mb-6">{translatedContent.role}</p>
          ...
          <div className="space-y-4 text-sm text-gray-300">
            <div className="flex items-start gap-3">
              ...
              <div>
                <span className="block text-white font-bold">
                  {t("team.athleticHighlights")}
                </span>
                <ul className="list-disc pl-4 mt-1 space-y-1">
                  {translatedContent.achievements.map((a, i) => (
                    <li key={i}>{a}</li>
                  ))}
                </ul>
              </div>
            ...
            {translatedContent.business && (
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p>{translatedContent.business}</p>
                </div>
              </div>
            )}
            ...
            {translatedContent.location && (
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p>{translatedContent.location}</p>
                </div>
              </div>
            )}

            {translatedContent.education &&
              translatedContent.education.length > 0 && (
                <div className="flex items-start gap-3">
                  <GraduationCap
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-4 mt-1 space-y-1">
                      {translatedContent.education.map((e, i) => (
                        <li key={i}>{e}</li>
                      ))}
                    </ul>
                  </div>
            ...
            {candidate.id === "pernilla" && (
              <div className="mt-6 hidden md:block">
                <span className="block text-white font-bold mb-3">
                  {t("team.photoGallery")}
                </span>
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {MORE_PHOTOS.map((photo, idx) => (
                      <div
                        key={`more-${idx}`}
                        className="w-full h-28 lg:h-36 xl:h-40 rounded-lg overflow-hidden"
                      >
                        <img
                          src={photo}
                  ...
                  {LUMI_GALLERY_PHOTOS.map((photo, idx) => (
                    ...
                    >
                      <img
                        ...
                        className="w-full h-full object-cover hover:opacity-80 transition-opacity cursor-pointer"
                        style={{
                          objectPosition: photo.includes("19.06.52")
                            ? "center 20%"
                            : "top",
                        }}
                        onClick={() => setLightboxImage(photo)}
              ...
              <div className="mt-6 hidden md:block">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {THOMAS_GALLERY_PHOTOS.map((photo, idx) => {
                    ...
                    if (properlyCroppedIndices.includes(idx))
                      objectPos = "center";
                    else if (tooMuchHeadroomIndices.includes(idx))
                      objectPos = "center 50%";
                    return (
                      <div
                        key={`thomas-${idx}`}
        ...
        {/* Right Content Area: Bio */}
        <div className="md:w-2/3 p-8 md:p-12">
          <h4 className="text-3xl font-extrabold text-navy-deep mb-6 font-serif">
            {t("team.biography")}
          </h4>
          ...
          <div className="mb-8 group relative rounded-xl overflow-hidden shadow-lg bg-navy-deep">
            {candidate.id === "pernilla" ? (
              ...
              <video
                controls
                className="w-full aspect-video object-cover"
                poster={`https://picsum.photos/seed/${candidate.id}video/800/450`}
              >
                <source
                  src={`/videos/${candidate.id}_bio.mp4`}
                  type="video/mp4"
                />
                <source
                  src="https://assets.mixkit.co/videos/preview/mixkit-people-jogging-on-a-running-track-32777-large.mp4"
                  type="video/mp4"
                />
                Your browser does not support the video tag.
              </video>
            ...
            <div className="bg-navy-light px-4 py-2 text-white text-sm">
              <span className="text-gold font-bold">Watch:</span> A personal
              message from {translatedContent.name.split(" ")[0]}.
            </div>
          </div>

          {/* Vision Statement / Manifesto */}
          {translatedContent.manifesto && (
          ...
          <div className="prose prose-lg text-gray-600">
            {translatedContent.bioFull.split("\n\n").map((paragraph, index) => (
              <p key={index} className="mb-4">
                {paragraph}
              </p>
            ))}

            {translatedContent.trackRecord && candidate.id === "thomas" && (
              <div className="bg-gold/10 p-6 rounded-lg border-l-4 border-gold mb-6">
                <h5 className="font-bold text-navy-deep mb-2 text-lg">
                  {t("team.trackRecord")}
                </h5>
                <p className="text-gray-700">{translatedContent.trackRecord}</p>
              </div>
            )}

            {translatedContent.governance.length > 0 && (
              <div className="bg-gray-50 p-6 rounded-lg border-l-4 border-gold mb-6">
                <h5 className="font-bold text-navy-deep mb-2 text-lg">
                  {t("team.governanceExperience")}
                </h5>
                <ul className="space-y-2">
                  {translatedContent.governance.map((g, i) => (
            ...
            {translatedContent.keyAchievement && (
              <div className="mt-8">
                <h5 className="font-bold text-navy-deep mb-2">
                  {t("team.keyAchievement")}
                </h5>
                <p className="text-navy-deep font-serif italic text-lg">
                  "{translatedContent.keyAchievement}"
                </p>
              </div>
            )}
            ...
            {candidate.id === "pernilla" && (
              <div className="mt-8">
                <h5 className="font-bold text-navy-deep mb-4">
                  {t("team.videos")}
                </h5>
                ...
                <div className="space-y-4">
                  ...
                  <div className="aspect-video rounded-lg overflow-hidden shadow-md">
                    <video
                      controls
                      preload="none"
                      poster="/Thomas/WOA Election Photos/WOA Election Video/thumbnails/IMG_1936.jpg"
                      className="w-full h-full object-cover"
                    >
                      <source
                        src="/Thomas/WOA Election Photos/WOA Election Video/IMG_1936.mp4"
                        type="video/mp4"
                      />
                    </video>
                  </div>
                  <div className="aspect-video rounded-lg overflow-hidden shadow-md">
                    <video
                      controls
                      preload="none"
                      poster="/Thomas/WOA Election Photos/WOA Election Video/thumbnails/IMG_2787.jpg"
                      className="w-full h-full object-cover"
                    >
                      <source
                        src="/Thomas/WOA Election Photos/WOA Election Video/IMG_2787.mp4"
                        type="video/mp4"
                      />
                    </video>
                  </div>
                  <div className="aspect-video rounded-lg overflow-hidden shadow-md">
                    <video
                      controls
                      preload="none"
                      poster="/Thomas/WOA Election Photos/WOA Election Video/thumbnails/IMG_3723.jpg"
                      className="w-full h-full object-cover"
                    >
                      <source
                        src="/Thomas/WOA Election Photos/WOA Election Video/IMG_3723.mp4"
                        type="video/mp4"
                      />
                    </video>
                  </div>
                  <div className="aspect-video rounded-lg overflow-hidden shadow-md">
                    <video
                      controls
                      preload="none"
                      poster="/Thomas/WOA Election Photos/WOA Election Video/thumbnails/IMG_4263.jpg"
                      className="w-full h-full object-cover"
                    >
                      <source
                        src="/Thomas/WOA Election Photos/WOA Election Video/IMG_4263.mp4"
                        type="video/mp4"
                      />
                    </video>
                  </div>
                  <div className="aspect-video rounded-lg overflow-hidden shadow-md">
                    <video
                      controls
                      preload="none"
                      poster="/Thomas/WOA Election Photos/WOA Election Video/thumbnails/IMG_6220.jpg"
                      className="w-full h-full object-cover"
                    >
                      <source
                        src="/Thomas/WOA Election Photos/WOA Election Video/IMG_6220.mp4"
                        type="video/mp4"
                      />
                    </video>
                  </div>
                  <div className="aspect-video rounded-lg overflow-hidden shadow-md">
                    <video
                      controls
                      preload="none"
                      poster="/Thomas/WOA Election Photos/WOA Election Video/thumbnails/IMG_8576.jpg"
                      className="w-full h-full object-cover"
                    >
                      <source
                        src="/Thomas/WOA Election Photos/WOA Election Video/IMG_8576.mp4"
                        type="video/mp4"
                      />
                    </video>
                  </div>
                  <div className="aspect-video rounded-lg overflow-hidden shadow-md">
                    <video
                      controls
                      preload="none"
                      poster="/Thomas/WOA Election Photos/WOA Election Video/thumbnails/IMG_9556.jpg"
                      className="w-full h-full object-cover"
                    >
                      <source
                        src="/Thomas/WOA Election Photos/WOA Election Video/IMG_9556.mp4"
                        type="video/mp4"
                      />
                    </video>
                  </div>
                  <div className="aspect-video rounded-lg overflow-hidden shadow-md">
                    <video
                      controls
                      preload="none"
                      poster="/Thomas/WOA Election Photos/WOA Election Video/thumbnails/IMG_9656.jpg"
                      className="w-full h-full object-cover"
                    >
                      <source
                        src="/Thomas/WOA Election Photos/WOA Election Video/IMG_9656.mp4"
                        type="video/mp4"
                      />
                    </video>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="aspect-video rounded-lg overflow-hidden shadow-md">
                    <video
                      controls
                      preload="none"
                      poster="/Lumi/Videos/thumbnails/WhatsApp Video 2025-12-09 at 22.30.38.jpg"
                      className="w-full h-full object-cover"
                    >
                      <source
                        src="/Lumi/Videos/WhatsApp Video 2025-12-09 at 22.30.38.mp4"
                        type="video/mp4"
                      />
                    </video>
                  </div>
                  <div className="aspect-video rounded-lg overflow-hidden shadow-md">
                    <video
                      controls
                      preload="none"
                      poster="/Lumi/Videos/thumbnails/WhatsApp Video 2025-12-09 at 19.44.32.jpg"
                      className="w-full h-full object-cover"
                    >
                      <source
                        src="/Lumi/Videos/WhatsApp Video 2025-12-09 at 19.44.32.mp4"
                        type="video/mp4"
                      />
                    </video>
                  </div>
                  <div className="aspect-video rounded-lg overflow-hidden shadow-md">
                    <video
                      controls
                      preload="none"
                      poster="/Lumi/Videos/thumbnails/WhatsApp Video 2025-12-09 at 21.34.38.jpg"
                      className="w-full h-full object-cover"
                    >
                      <source
                        src="/Lumi/Videos/WhatsApp Video 2025-12-09 at 21.34.38.mp4"
                        type="video/mp4"
                      />
                    </video>
                  </div>
                  <div className="aspect-video rounded-lg overflow-hidden shadow-md">
                    <video
                      controls
                      preload="none"
                      poster="/Lumi/Videos/thumbnails/WhatsApp Video 2025-12-09 at 21.34.38 (1).jpg"
                      className="w-full h-full object-cover"
                    >
                      <source
                        src="/Lumi/Videos/WhatsApp Video 2025-12-09 at 21.34.38 (1).mp4"
                        type="video/mp4"
                      />
                    </video>
                  </div>
                  <div className="aspect-video rounded-lg overflow-hidden shadow-md">
                    <video
                      controls
                      preload="none"
                      poster="/Lumi/Videos/thumbnails/WhatsApp Video 2025-12-09 at 21.34.40.jpg"
                      className="w-full h-full object-cover"
                    >
                      <source
                        src="/Lumi/Videos/WhatsApp Video 2025-12-09 at 21.34.40.mp4"
                        type="video/mp4"
                      />
                    </video>
                  </div>
                  <div className="aspect-video rounded-lg overflow-hidden shadow-md">
                    <video
                      controls
                      preload="none"
                      poster="/Lumi/Videos/thumbnails/WhatsApp Video 2025-12-09 at 21.39.58.jpg"
                      className="w-full h-full object-cover"
                    >
                      <source
                        src="/Lumi/Videos/WhatsApp Video 2025-12-09 at 21.39.58.mp4"
                        type="video/mp4"
                      />
                    </video>
                  </div>
                  <div className="aspect-video rounded-lg overflow-hidden shadow-md">
                    <video
                      controls
                      preload="none"
                      poster="/Lumi/Videos/thumbnails/WhatsApp Video 2025-12-09 at 21.47.54.jpg"
                      className="w-full h-full object-cover"
                    >
                      <source
                        src="/Lumi/Videos/WhatsApp Video 2025-12-09 at 21.47.54.mp4"
                        type="video/mp4"
                      />
                    </video>
                  </div>
                  <div className="aspect-video rounded-lg overflow-hidden shadow-md">
                    <video
                      controls
                      preload="none"
                      poster="/Lumi/Videos/thumbnails/WhatsApp Video 2025-12-09 at 21.47.55.jpg"
                      className="w-full h-full object-cover"
                    >
                      <source
                        src="/Lumi/Videos/WhatsApp Video 2025-12-09 at 21.47.55.mp4"
                        type="video/mp4"
                      />
                    </video>
                  </div>
                  <div className="aspect-video rounded-lg overflow-hidden shadow-md">
                    <video
                      controls
                      preload="none"
                      poster="/Lumi/Videos/thumbnails/WhatsApp Video 2025-12-09 at 22.08.08.jpg"
                      className="w-full h-full object-cover"
                    >
                      <source
                        src="/Lumi/Videos/WhatsApp Video 2025-12-09 at 22.08.08.mp4"
                        type="video/mp4"
                      />
                    </video>
                  </div>
                  <div className="aspect-video rounded-lg overflow-hidden shadow-md">
                    <video
                      controls
                      preload="none"
                      poster="/Lumi/Videos/thumbnails/WhatsApp Video 2025-12-09 at 22.34.24.jpg"
                      className="w-full h-full object-cover"
                    >
                      <source
                        src="/Lumi/Videos/WhatsApp Video 2025-12-09 at 22.34.24.mp4"
                        type="video/mp4"
                      />
                    </video>
                  </div>
