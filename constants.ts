...
export const CANDIDATES: Candidate[] = [
  ...
  },
  {
    ...
    keyAchievement: 'NBA Star turned athlete advocate. Turned Nigeria Olympians Association around through rebranding, secured insurance benefits for Olympians, established Olympians Village and recreation center with hectares of land, achieved NOA inclusion as full Exco member of NOC, established Olympians Trust Fund. Rewarding, supporting, and celebrating Olympians while promoting Olympians inclusion in decision making. Founded programs that have mentored 45,000+ young people across 30+ cities worldwide.',
