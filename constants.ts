...
export const CANDIDATES: Candidate[] = [
  {
    ...
    business: 'Entrepreneur, investor and business leader. CEO of Pernilla Wiberg Sportpromotion.',
    bioFull: 'Pernilla Wiberg is a legend on the slopes and a powerhouse in the boardroom. As a Triple Olympic Medalist with 24 individual World Cup victories, 61 World Cup podiums, and the 1997 Overall World Cup title, she is one of the few skiers in history to win races in all five alpine disciplines—her 1991 World Championship gold was the first for a Scandinavian woman in 33 years.\n\nBeyond competition, she became a renowned TV sports commentator for Sveriges Television (SVT). In governance, she served as an IOC Member for eight years across multiple commissions, chaired the IOC Evaluation Commission for the first Winter Youth Olympic Games, and represented the WOA on the IOC Athletes\' Commission from 2020–2025.\n\nAs current WOA Vice President, she was instrumental in the historic 50/50 continental gender representation reform of the WOA consitution. A Champions for Peace member and successful entrepreneur, she has business interested in hospitality, such as the Pernilla Wiberg Hotel in Sweden and is CEO of Pernilla Wiberg Sportpromotion. Based in Sweden and Monaco since 1995—strategically positioned near WOA Patron Prince Albert and the IOC in Lausanne. She is married to Bødvar Bjerke from Norway and has two children: Axel (born 2003) and Sofia (born 2007). Pernilla is fluent in Swedish, English, French, German, and Norwegian.',
    manifesto: 'As Olympians, we need the WOA. To connect, support, and empower us, and help us through our life transition, and particularly to advocate for our rights within the Olympic Movement.\n\nWe need a strong, independent WOA working hard to meet our needs, to help you grow your NOA, and your community projects.\n\nWOA has done a lot the past 14 years. Gender equality in the continental groupings, creation of OLY and the NOA grants programs. Development Officers, University scholarships, "Target Ebola" and "Olympians for Ukraine" campaigns, the "World Olympians Forum" and the "Olympians Health Survey." None of that existed before.\n\nThe Olympic Games generate lots of money, is it correctly divided? Do Olympians have access to a pension system? Do we have access to a health system or an insurance throughout our lives? Do we have full access to the footage of our performance at the Games?\n\nBut I would like to hear from you in a more structured way. My first task, if elected, will be to undertake a full 360 review of our processes, our priorities, and a survey of your wishes and needs.\n\nTogether we can make a real impact, by not being afraid of change or tackling the difficult subjects, by listening to each other and working together.\n\nAs Olympians we have a power. Let us use it. I am ready to take on the challenge, are you?',
    socialLinks: {
  ...
  },
  {
    ...
    keyAchievement: 'NBA star turned athlete advocate. Transformed Nigeria Olympians Association and founded youth development initiatives, independently and with partners, reaching over 45,000 young people across 30+ cities in 20+ countries.',
  ...
  },
  {
    ...
    manifesto: `As part of a strong leadership team alongside Pernilla Wiberg and Olumide Oyedeji, I am running for Treasurer of the World Olympians Association with a clear mission to safeguard WOA's financial integrity, strengthen its long-term sustainability, and ensure Olympians benefit from transparent, accountable, and impactful resource management.

[My professional background](https://app.box.com/s/5xdpz83s6jj72m7z4ozbp4ts601bsj2a) spans more than 30 years of executive leadership across international business, technology, and nonprofit development. I have managed multimillion-dollar budgets, built successful global organizations, and implemented robust financial systems grounded in responsibility and trust. I will bring these same principles to serve the WOA.

I will prioritize financial transparency and accountability through clear reporting standards, continued independent audits, and open communication so every NOA can clearly understand how WOA resources are utilized. I will also focus on securing sustainable funding and building long-term partnerships that honor Olympic values while ensuring WOA remains financially strong and independent. Collaboration with the IOC is essential for alignment and shared purpose, yet WOA must always preserve its autonomy and its ability to advocate for Olympians with clarity and neutrality.

My commitment extends to service at the community level, where the heart of the Olympian movement truly lives. I will work to ensure more resources reach grassroots initiatives, supporting education, health, career transition, and youth programs, while giving special attention to smaller NOAs and developing nations to ensure equitable access and meaningful impact.

As Treasurer, I will serve with integrity, discipline, and unwavering dedication, strengthening the WOA and empowering Olympians for generations to come.`,
...
export const CORE_MESSAGES = [
  ...
  },
  {
    ...
    description: 'Together, our team helped champion the protection of WOA independence while rebuilding a productive working relationship with the IOC that delivers funding and new opportunities for WOA, the NOAs, and Olympians.',
    icon: 'Shield'
  },
  {
    id: 'lead',
