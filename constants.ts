...
export const CANDIDATES: Candidate[] = [
  {
    ...
    bioFull: 'Pernilla Wiberg is a legend on the slopes and a powerhouse in the boardroom. As a Triple Olympic Medalist with 24 individual World Cup victories, 61 World Cup podiums, and the 1997 Overall World Cup title, she is one of the few skiers in history to win races in all five alpine disciplines—her 1991 World Championship gold was the first for a Scandinavian woman in 33 years.\n\nBeyond competition, she became a renowned TV sports commentator for Sveriges Television (SVT). In governance, she served as an IOC Member for eight years across multiple commissions, chaired the IOC Evaluation Commission for the first Winter Youth Olympic Games, and represented the WOA on the IOC Athletes\' Commission from 2020–2025.\n\nAs current WOA Vice President, she was instrumental in the historic 50/50 gender representation reform. A Champions for Peace member and successful entrepreneur, she owns and operates the Pernilla Wiberg Hotel in Sweden and is CEO of Pernilla Wiberg Sportpromotion. Based in Idre Fjäll, Sweden and Monte Carlo, Monaco since 1995—strategically positioned near WOA Patron Prince Albert and the IOC in Lausanne. She is married to Bødvar Bjerke from Norway and has two children: Axel (born 2003) and Sofia (born 2007). Fluent in Swedish, English, French, German, and Norwegian.',
    manifesto: 'As an Olympian, former IOC Member, and current WOA Vice President, I am running for President of the World Olympians Association with a clear mission: to connect, support, and empower Olympians throughout their lives—while advocating fiercely for our rights within the Olympic movement. The WOA must be strong, independent, and laser-focused on meeting the needs of Olympians and helping your NOAs grow and thrive.\n\nOver the past 14 years, we have transformed the WOA from an idea into reality. We created the OLY post-nominal letters that unite us as a global community. We established the World Olympians Forum and the OLY Houses that celebrate our shared identity. We secured NOA Development Grants, Service to Society Grants, and university scholarships. We launched life-changing campaigns like #TargetEbola and #OlympiansforUkraine. We conducted the first-ever global health survey of Olympians. And I personally chaired the constitutional reforms that achieved historic 50/50 gender representation. None of this existed before we built it.\n\nBut our work is not finished. The Olympic movement stands on three pillars: National Olympic Committees, International Federations, and Olympians. Without us, there are no Olympics and vice versa. Yet the fundamental questions remain: Do Olympians have access to pension systems? Do we have lifetime health coverage? Do we control the footage of our own performances? These are the battles we must win.\n\nIf elected, our first priority will be a comprehensive 360-degree review of WOA processes, priorities, and a survey of your needs. We want to hear from you in a structured way because your voice must shape our direction. We will work to secure an even stronger agreement with the IOC while pursuing outside funding to increase grants to NOAs and Olympians.\n\nI have assembled an extraordinary team for this mission. Olumide "Lumi" Oyedeji as Secretary General brings his experience as NOC Vice President and his foundation that has impacted over 45,000 young people. Thomas Tang as Treasurer brings his entrepreneurial brilliance and global business expertise. Together, we represent three continents and combine Olympic excellence with proven leadership in sports administration and business.\n\nA strong WOA working in harmony with the IOC requires exceptional leadership. We have the experience, the track record, and the vision to deliver. Together, we can have enormous impact—not by fearing change, but by embracing it. By tackling difficult subjects head-on. By listening to each other and working together as Olympians.\n\nWe have the power to shape our future. Let\'s use it. We are ready for the challenge. Are you?',
    socialLinks: {
  ...
  },
  {
    ...
    governance: [
      ...
      'President: Nigeria Olympians Association',
      ...
      'Former Executive Member: FIBA Players\' Commission',
      'Vice Chairman: FIBA Zone 3 Development Council',
      'Board Member: Nigeria Basketball Federation',
      'President: Sports For All Commission NOC'
    ],
    keyAchievement: 'NBA Star turned athlete advocate. Transformed Nigeria Olympians Association and founded youth programs mentoring 45,000+ young people across 30+ cities in 20+ countries worldwide.',
  ...
  },
  {
    ...
    keyAchievement: 'Business and Technology Wizard. Built a global tech company from scratch powering Olympic Games and FIFA World Cup broadcasts worldwide. Active in winter sports development.',
    ...
    manifesto: `As an Olympian, leader, and global advocate for athletes, I am running for Treasurer of the World Olympians Association with a clear mission to safeguard WOA's financial integrity, strengthen its long-term sustainability, and ensure that Olympians benefit from transparent, accountable, and impactful resource management. My [professional background](https://app.box.com/s/5xdpz83s6jj72m7z4ozbp4ts601bsj2a) includes more than 30 years of executive leadership across international business, technology, and nonprofit development. I have managed multimillion-dollar budgets, built successful global organizations, and implemented solid financial systems. I will bring these same principles and skills gained to the WOA.

If elected, I will ensure financial transparency and accountability through clear reporting standards, continued independent audits, and maintain open communication so that every NOA can see exactly how WOA resources are utilized. I will work to secure sustainable funding and build long-term partnerships that honor Olympic values while ensuring WOA remains financially strong and independent. I believe collaboration with the IOC is essential for alignment and shared purpose, yet WOA must always maintain its own identity, autonomy, and the ability to advocate for Olympians with clarity and neutrality.

My commitment extends to service at the community level, where the heart of the Olympian movement truly lives. I will ensure more resources reach grassroots initiatives by supporting education, health, career transition, and local programs that uplift youth and inspire hope. Smaller NOAs and developing nations will receive special attention to ensure equitable access and meaningful impact.

I believe deeply in the power of Olympians to inspire peace, service, and unity. As Treasurer, I will honor that responsibility with integrity, discipline, and unwavering commitment. Together, we will strengthen the WOA and empower Olympians for generations to come.`,
    bioFull: 'Thomas Tang combines Olympic grit with Silicon Valley innovation. A two-time Winter Olympian for Chinese Taipei who competed at World Championships and World Cups, he now serves as Chef de Mission for Guinea-Bissau at the 2026 Milano-Cortina Olympics and Secretary General of their Winter Sports Federation—driving the introduction of winter sports in a tropical nation, securing FIS membership, and establishing athlete development programs. His Olympic legacy is a family affair—his daughter competed at Figure Skating at an international level, and his sons have qualified for the 2022 and 2026 Olympics in Alpine Skiing.\n\nThomas founded Apantac in his basement during the 2008 financial crisis and built it into a global broadcast, ProAV, and openGear technology leader—winning multiple "Best of Show" awards including the prestigious NAB PICK HIT AWARD in 2009, and now shipping 200+ products to 40+ countries, from Greenland to New Zealand. His technology has powered Olympic broadcasts, Soccer World Cups, major professional sports leagues, and national broadcasters worldwide, and is used daily by leading social media for their event spaces.\n\nHis 30+ year career spans executive leadership across international business, technology, and nonprofit development. Prior to founding Apantac, he served as Vice President at Avitech International (2004–2008) leading global sales and product expansion in broadcast and multiviewer technologies, Director of Marketing at Philips Electronics Broadcast Division (1999–2004) directing strategy across North America and Asia-Pacific with $50M P&L responsibility, Asia Pacific Area Director at Vizrt (1997–1999) expanding market presence for broadcast graphics and real-time visualization systems, and Regional Sales Manager at Evans & Sutherland (1989–1997) where he started as a Senior Software Engineer working on F-14/F-16 flight simulators and NASA Space Shuttle training systems before advancing to regional sales.\n\nThomas holds patents and published works including Laser Spectroscopy (SPIE, 1987), Physical Camera Calibration with Virtual Backgrounds (1996), Dynamic Shadows in Virtual Studio Production (1997), Cascading Multiviewer Outputs via SATA (2009), Mechanical Magnetic Mounting for AV Equipment (2014), and Intelligent EDID-Based DA Output Management (2018).\n\nHe also serves as Board Member of the Taiwanese American Chamber of Commerce (2023–Present), supporting cross-Pacific business collaboration and Taiwanese entrepreneurship in North America, and as President of Eubank Investment Group (2012–Present) and Anextus Trading & Export in Guinea-Bissau (2024–Present).\n\nWith Harvard Business School executive education in Marketing & Business Strategy, an M.S. in Computer Science from Westminster College, and both an M.S. in Applied Physics and B.S. in Physics from the University of Utah, Thomas brings unmatched financial acumen and operational excellence to the WOA. Fluent in English, Mandarin, Cantonese, and Taiwanese.',
    socialLinks: {
