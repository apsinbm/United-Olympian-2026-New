        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="font-sans font-extrabold text-lg tracking-wider">
                {t("footer.brand")}
              </span>
            </div>
          ...
          <div>
            <h4 className="font-bold text-gold uppercase tracking-widest text-sm mb-4">
              {t("footer.navigation")}
            </h4>
            <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <li>
                <Link to="/priorities" className="hover:text-white transition">
                  {t("nav.priorities")}
                </Link>
              </li>
              <li>
